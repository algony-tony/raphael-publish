import { ArrowLeft, Moon, Sun, Github } from 'lucide-react';
        ...
        <header className="glass flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 sticky top-0 z-[100]">
            <div className="flex items-center gap-3">
                <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    href="/tools/"
                    className="flex items-center gap-1 px-2 py-1.5 rounded-lg text-[13px] text-[#86868b] dark:text-[#a1a1a6] hover:text-black dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/10 transition-colors"
                >
                    <ArrowLeft size={14} />
                    <span className="hidden sm:inline">返回工具箱</span>
                </motion.a>
            ...
            <div className="flex items-center gap-4">
                <span className="hidden lg:inline text-[11px] text-[#86868b] dark:text-[#a1a1a6]">
                    Based on <a href="https://github.com/liuxiaopai-ai/raphael-publish" target="_blank" rel="noopener noreferrer" className="underline hover:text-black dark:hover:text-white transition-colors">Raphael Publish</a> (MIT)
                </span>
                <motion.a
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    href="https://github.com/algony-tony/raphael-publish"
                    target="_blank"
